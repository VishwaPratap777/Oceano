...
export const TextHoverEffect = ({
  ...
  return (
    ...
    >
      <defs>
        {/* Gradient for the text reveal */}
        <linearGradient id="textGradient" gradientUnits="userSpaceOnUse">
          {hovered && (
            <>
              <stop offset="0%" stopColor="#002f6c" />
              <stop offset="25%" stopColor="#00aaff" />
              <stop offset="50%" stopColor="#00e6c3" />
              <stop offset="75%" stopColor="#0099cc" />
              <stop offset="100%" stopColor="#66e0ff" />
            </>
          )}
        </linearGradient>

        {/* Radial gradient mask following the cursor */}
        ...
        {/* Glow filter for the revealed area */}
      ...
      {/* Gradient stroke with mask and glow */}
      <text
        x="50%"
        y="50%"
        dy=".35em"
